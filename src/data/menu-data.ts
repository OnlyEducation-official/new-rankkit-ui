...
const menu_data: IMenuDT[] = [
  ...
  },
  {
    ...
    //             link: "/portfolio-grid-col-3-fullwidth",
    //           },
    //           { title: "four-columns", link: "/portfolio-grid-col-4" },
    //           {
    //             title: "four-columns Wide",
    //             link: "/portfolio-grid-col-4-fullwidth",
    //           },
    //         ],
    //       },
    //       {
    ...
    //             link: "/portfolio-details-comparison",
    //           },
...
export const mobile_menu_data: {
  ...
  },
  {
    ...
    dropdown_menus: [
      ...
      {
        title: "Branding and Multimedia Desigining",
        link: "/Branding-Multimedia-Desigining",
      },
      { title: "Media Produciton ", link: "/media-production" },
      { title: "Creator Nest", link: "/creator-nest" },
  ...
  },
  {
    ...
    link: "#",
    dropdown_menus: [
      { title: "Only Education", link: "/only-education" },
      { title: "Neet Gyan", link: "/neet-gyan" },
      { title: "The Kerala Table", link: "/the-kerala-table" },
      { title: "Only Engineering", link: "/only-engineering" },
      { title: "MBA CET", link: "/mba-cet" },
      { title: "Kalp", link: "/kalp" },
      { title: "Bake Your Day", link: "/bake-your-day" },
      { title: "Toy Room", link: "/toy-room" },
      // { title: 'Image Slider', link: '/home-7' },
      // { title: 'wrapper Slider', link: '/home-11' },
      // { title: 'parallax showcase', link: '/portfolio-showcase' },
      // { title: 'Perspective Slider', link: '/home-9' },
